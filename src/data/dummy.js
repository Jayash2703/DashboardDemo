...
export const employeesGrid = [
  ...
  // Add the keys for the academic and research activities
  {
    field: 'ResearchPublication',
    headerText: 'Research Publications',
    width: '150',
    textAlign: 'Center',
  },
  {
    field: 'BookPublication',
    headerText: 'Book Publications',
    width: '150',
    textAlign: 'Center',
  },
  {
    field: 'FacultyConferencePublication',
    headerText: 'Faculty Conf. Publications',
    width: '200',
    textAlign: 'Center',
  },
  {
  ...
  {
    field: 'ConsultancyReport',
    headerText: 'Consultancy Reports',
    width: '180',
    textAlign: 'Center',
  },
  {
    field: 'PatentPublication',
    headerText: 'Patent Publications',
    width: '180',
    textAlign: 'Center',
  },
  {
    field: 'ConferencesSeminarsWorkshopsFDPSTTPOrganizedConducted',
    headerText: 'Conferences & Workshops',
    width: '250',
    textAlign: 'Center',
  },
  {
    field: 'STTPFDPWorkshopConferenceAttended',
    headerText: 'STTP/FDP Attended',
    width: '200',
    textAlign: 'Center',
  },
  {
    field: 'WebinarGuestExpertLectureVideoConferenceInvitedTalksOrganizedConducted',
    headerText: 'Webinars & Lectures',
    width: '250',
    textAlign: 'Center',
  },
  {
    field: 'NumberOfMoUsCollaborationsLinkagesForFacultyExchange',
    headerText: 'MoUs & Collaborations',
    width: '220',
    textAlign: 'Center',
  },
  {
    field: 'CertificateCourses',
    headerText: 'Certificate Courses',
    width: '180',
    textAlign: 'Center',
  },
  {
    field: 'ProfessionalAffiliations',
    headerText: 'Professional Affiliations',
    width: '220',
    textAlign: 'Center',
  },
  {
    field: 'FacultyAsResourcePerson',
    headerText: 'Resource Person',
    width: '180',
    textAlign: 'Center',
  },
  {
    field: 'ExtensionActivity',
    headerText: 'Extension Activity',
    width: '200',
    textAlign: 'Center',
  },
  {
    field: 'FacultyQualificationNewlyJoined',
    headerText: 'New Qualification',
    width: '200',
    textAlign: 'Center',
  },
  {
    field: 'TechnicalCompetitionsTechFestOrganizedExtraCoCurricularActivitiesOrganized',
    headerText: 'Tech Competitions & Activities',
    width: '250',
    textAlign: 'Center',
  },
  {
    field: 'FacultyAchievement',
    headerText: 'Achievements',
    width: '200',
    textAlign: 'Center',
  },
  {
    field: 'IndustrialVisitsToursFieldTrip',
    headerText: 'Industrial Visits',
    width: '180',
    textAlign: 'Center',
  },
  {
    field: 'ContributionToBoS',
    headerText: 'BoS Contribution',
    width: '200',
    textAlign: 'Center',
  },
];
...
export const chatData = [
  {
    image:
      avatar2,
    message: '  Want access of IT seminar hall',
    desc: 'Xyz sent you msg',
    time: '9:08 AM',
  },
  {
    image:
  ...
  export const employeesData = [
    {
      ...
      UserID: 'aaghotkar@pict.edu',
      Title: 'Professor',
      HireDate: '01/02/2010',
      Country: 'India',
      ReportsTo: 'Dean',
      EmployeeImage: 'avatar1.jpg',
  
      ResearchPublication: 10,
      BookPublication: 3,
      FacultyConferencePublication: 5,
      Grants: 2,
      ConsultancyReport: 8,
      PatentPublication: 1,
      ConferencesSeminarsWorkshopsFDPSTTPOrganizedConducted: 15,
      STTPFDPWorkshopConferenceAttended: 20,
      WebinarGuestExpertLectureVideoConferenceInvitedTalksOrganizedConducted: 10,
      NumberOfMoUsCollaborationsLinkagesForFacultyExchange: 3,
      CertificateCourses: 4,
      ProfessionalAffiliations: ['IEEE', 'ACM'],
      FacultyAsResourcePerson: 12,
      ExtensionActivity: 'Community outreach program',
      FacultyQualificationNewlyJoined: 'Ph.D. in Computer Engineering',
      TechnicalCompetitionsTechFestOrganizedExtraCoCurricularActivitiesOrganized: 5,
      FacultyAchievement: 'Best Research Paper Award 2021',
      IndustrialVisitsToursFieldTrip: 2,
      ContributionToBoS: 'Member of BoS for Computer Science',
    },
    {
      EmployeeID: 2,
      Name: 'Dr. Emmanuel Markappa',
      UserID: 'emmanuelm@pict.edu',
      Title: 'Associate Professor',
      HireDate: '05/15/2015',
      Country: 'India',
      ReportsTo: 'Head of Department',
      EmployeeImage: 'avatar2.jpg',
  
      ResearchPublication: 8,
      BookPublication: 2,
      FacultyConferencePublication: 4,
      Grants: 1,
      ConsultancyReport: 6,
      PatentPublication: 0,
      ConferencesSeminarsWorkshopsFDPSTTPOrganizedConducted: 12,
      STTPFDPWorkshopConferenceAttended: 18,
      WebinarGuestExpertLectureVideoConferenceInvitedTalksOrganizedConducted: 8,
      NumberOfMoUsCollaborationsLinkagesForFacultyExchange: 2,
      CertificateCourses: 3,
      ProfessionalAffiliations: ['ACM', 'ISEC'],
      FacultyAsResourcePerson: 10,
      ExtensionActivity: 'STEM education initiative',
      FacultyQualificationNewlyJoined: 'Ph.D. in Electrical Engineering',
      TechnicalCompetitionsTechFestOrganizedExtraCoCurricularActivitiesOrganized: 4,
      FacultyAchievement: 'Outstanding Teaching Award 2020',
      IndustrialVisitsToursFieldTrip: 1,
      ContributionToBoS: 'Member of BoS for Electrical Engineering',
    },
